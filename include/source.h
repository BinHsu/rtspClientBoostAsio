...
namespace media
{
    ...
    class source
    {
        ...
        std::list<std::tuple<std::shared_ptr<stream>, ip::udp::endpoint, ip::udp::endpoint> > streams;
    ...
    public:
        ...
        void open_stream(const boost::asio::ip::address& iface, const char* cname, int& rtp_port, int& rtcp_port, const ip::udp::endpoint rtp_peer, const ip::udp::endpoint rtcp_peer);
